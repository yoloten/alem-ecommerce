...
export default function AdminMacro(props: any) {
    ...
    const changeMacroProperties = (e: any) => {
        ...
        if (e.target.name === "type") {
            ...
            if (e.target.value === "string") {
                newMacros[parseInt(e.target.id, 10)].validatorsList = ["minLength", "maxLength", "pattern", "pattern-description", "mask", "required"]
            }
    ...
    const addMacro = () => setMacros([...macros, {
        label: "",
        name: "",
        type: "",
        validators: {},
    ...
    const addOption = (e: any) => {
        ...
        newMacro[parseInt(e.target.id, 10)].options = [...newMacro[parseInt(e.target.id, 10)].options, {
            name: "",
            label: "",
            value: "",
            meta: {},
                                ...
                                <div className="admin-attribute-macro-props">
                                    <div className="attribute-macro-item">
                                        <Dropdown
                                            ...
                                            bgColor="#f3f3f3"
                                            border={false}
                                            width={setInputWidth(props.windowWidth)}
                                            height="40"
                                            name="type"
                                            placeholder="Type"
                                                ...
                                                return (
                                                    <div key={`option-${index}`} className="attributes-validators-list">
                                                        <Input
                                                            ...
                                                            width={setInputWidth(props.windowWidth) - 20}
                                                            height="31"
                                                            border={true}
                                                            borderRadius="0px"
                                                ...
                                                ? macro.validatorsList.slice(0, 3).map((item: any, i: number) => {
                                                    if (item === "required") {
                                                        return <div
                                                            ...
                                                            style={{ width: setInputWidth(props.windowWidth) - 5 + "px" }}
                                                        >
                                                        ...
                                                        if (macro.type === "number") {
                                                            return <Input
                                                                ...
                                                                onChange={onValidatorChange}
                                                                borderRadius="0px"
                                                                width={setInputWidth(props.windowWidth) - 5}
                                                                border={true}
                                                                height="31"
                                                                id={macroIndex.toString()}
                                                                className={macro.type}
                                            ...
                                            {macro.type === "string" && macro.validatorsList
                                                ? macro.validatorsList.slice(3, 6).map((item: any, i: number) => {
                                                    if (item === "required") {
                                                        return <div
                                                            className="attrbute-checkbox-div"
                                                            style={{ width: setInputWidth(props.windowWidth) + 15 + "px" }}
                                                        >
                                                            <div className="attribute-checkbox-label">Required:</div>
                                                            <input
                                                                type="checkbox"
