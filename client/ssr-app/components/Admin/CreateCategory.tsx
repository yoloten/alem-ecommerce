...
export default function CreateCategory() {
    ...
    const addChild = (e: any) => {
        ...
        const { id } = e.target
        const newTree = [...tree]
        const child: CreateCategories.Category = {
            name: "",
            parents: [],
            uuid: v4(),
            created_index: 0,
        ...
        if (id) {
            newTree.map((item: CreateCategories.Category, i: number) => {
                if (item.uuid === id) {
            ...
            <div className="admin-left-side">
                ...
                <ul>
                    <li className="admin-li">
                        ...
                        <div className="admin-text">
                            It will not be seen anywhere except database.
                        </div>
                    </li>
                    <li className="admin-li">
                        <div className="admin-text">
                        ...
                        <div className="admin-text">
                            Actually they are the main categories. For instance, you've got clothes shop.
                            That shop has clothes for men, women and kids.
                            So that categories have to be seen to user from everywhere.
                            And that means users after navigation to one of those categories
                            see categories and content that belongs to it.
                        </div>
                    </li>
                    <li className="admin-li">
                        <div className="admin-text">
                        ...
                        <div className="admin-text">
                            Categories of this level will be seen on the sidebar
                            after you chosing one of the level 2 categories.
                            Level 3 categories will contain children categories that will have product.
                        </div>
                    </li>
                    <li className="admin-li">
                        <div className="admin-text">
                        ...
                        <div className="admin-text">
                            Let's look at example: We are openning "Men"(level 2).
                            There will be categories such as Jeans and T-shirts(level 3).
                            When we click on one of them we see filters page with all
                            level 4 categories that level 3 category has.
                            We can filter products by chosing level 4 categories.
                            For instance, we chose Slim Jeans(level 4)
                            and the result will be all products with that category.
                            So again level 4 categories will contain products.
                            Only level 4 categories will be seen in "Create Product".
                           <div className="admin-text">
